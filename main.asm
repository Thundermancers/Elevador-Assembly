...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Setting defines, sets and etc...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

.def temp = r16		; temporary variable
#define CLOCK 16.0e6		; clock speed
#define DELAY 1		; how many counts I want to do
...
.equ offset_S_S = 27
.equ offset_S_M = 28
.equ offset_DOOR_CNT = 33
.equ offset_FLOOR_CNT = 38
.equ offset_WAIT_TIME_FLAG = 42
...
INIT_TIMERS :
	...
	.equ TOP = int(0.5 + ((CLOCK/PRESCALE_DIV)*DELAY))		; defining TOP value
...
INIT_LOG_STRING:
	; Config log call elevator 4 bytes
	ldi temp, 'E'
	sts logs, temp
	ldi temp, ' '
	sts logs+1, temp
	...
	; Config log call outside 5 bytes
	ldi temp, 'O'
	sts logs+7, temp
	ldi temp, 'S'
	sts logs+8, temp
	...
	; Config log call output2 5 bytes
	ldi temp, 'O'
	sts logs+19, temp
	ldi temp, ' '
	sts logs+20, temp
